...
public class ClienteRegistrado extends JFrame {
    ...
    public ClienteRegistrado(boolean soyRegistrado) {
        /**
    *  En este campo damos toddas las caracteristicas de la ventana
    *
    * @author Juan David Zapata
    * @version 09/07/2015
    */
        ...
        // Caracteristicas de la fuente del texto
        ...
        /**
    * En este campo damos ubicación a los objetos 
    *
    * @author Juan David Zapata
    * @version 09/07/2015
    */
        ...
        //Este campo es para dar acciones a los botones
